...
**logzio-otel-k8s-metrics** allows you to ship metrics and traces from your Kubernetes cluster to Logz.io with the OpenTelemetry collector.
...
logzio-otel-telemetry logzio-helm/logzio-otel-telemetry
```
...
```
helm install logzio-otel-k8s-telemetry
 logzio-helm/logzio-otel-telemetry -f my_values.yaml 
```
...
To uninstall the `logzio-otel-k8s-telemetry` deployment, use the following command:

```shell
helm uninstall logzio-otel-k8s-telemetry
```
