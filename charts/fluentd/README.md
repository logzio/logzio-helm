...
| `windowsDaemonset`                        | Set [nodeSelector](https://kubernetes.io/docs/concepts/scheduling-eviction/taint-and-toleration/) for all DaemonSet pods.                                                                                                                | `{"kubernetes.io/os": "windows"}`                                                                |                                                               |
